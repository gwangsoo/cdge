...
import com.hae.repository.PictureRepository;
import com.hae.service.dto.PictureDTO;
import com.hae.service.mapper.PictureMapper;
...
class PictureResourceIT {
    ...
    public static Picture createEntity(EntityManager em) {
        Picture picture = new Picture().context(DEFAULT_CONTEXT);
        return picture;
    }
    ...
    public static Picture createUpdatedEntity(EntityManager em) {
        Picture picture = new Picture().context(UPDATED_CONTEXT);
        return picture;
    }
    ...
    void createPicture() throws Exception {
        ...
        assertThat(testPicture.getContext()).isEqualTo(DEFAULT_CONTEXT);
    }
    ...
    void putNewPicture() throws Exception {
        ...
        updatedPicture.context(UPDATED_CONTEXT);
        ...
        Picture testPicture = pictureList.get(pictureList.size() - 1);
        assertThat(testPicture.getContext()).isEqualTo(UPDATED_CONTEXT);
    }
    ...
    void fullUpdatePictureWithPatch() throws Exception {
        ...
        partialUpdatedPicture.context(UPDATED_CONTEXT);
