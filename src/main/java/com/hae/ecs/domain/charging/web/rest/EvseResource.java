...
import com.hae.ecs.domain.charging.repository.EvseRepository;
import com.hae.ecs.domain.charging.service.EvseService;
...
/**
 * REST controller for managing {@link com.hae.ecs.domain.charging.domain.Evse}.
 */
@RestController
@RequestMapping("/api")
