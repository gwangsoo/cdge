...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.hae.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.hae.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.hae.domain.User.class.getName());
            createCache(cm, com.hae.domain.Authority.class.getName());
            createCache(cm, com.hae.domain.User.class.getName() + ".authorities");
            createCache(cm, com.hae.domain.Connector.class.getName());
            createCache(cm, com.hae.domain.Pricing.class.getName());
            createCache(cm, com.hae.domain.Evse.class.getName());
            ...
            createCache(cm, com.hae.domain.Station.class.getName() + ".pictures");
