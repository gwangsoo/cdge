...
import com.hae.service.PictureService;
...
/**
 * REST controller for managing {@link com.hae.domain.Picture}.
 */
@RestController
@RequestMapping("/api")
public class PictureResource {
     ...
     */
    @GetMapping("/pictures")
    public ResponseEntity<List<PictureDTO>> getAllPictures(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
